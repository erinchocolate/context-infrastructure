...
**`02 trusted/OBSERVATIONS.md` 格式：**

```markdown
## 2026-04-11
🔴 [跨项目洞察，2-3 句话]
🟡 [活跃项目的关键决策/进展/问题，2-3 句话]
🟢 [常规完成记录，1 句话]
...
维护规则：
- 新条目追加在文件**顶部**（最新日期在最上面）
- 绿色条目 weekly 时清理
- 黄色条目 weekly 时 merge 同类、删除已解决的
- 红色条目晋升为 axiom/skill 后标记 `✅ 已晋升 → <文件路径>`
...
4. 清理已过期的绿色条目
5. 合并重复的黄色条目
6. 将反思结果写为独立的 weekly reflection 文件
```

**Weekly reflection 文件：**

- 路径：`02 trusted/YYYYMMDD_weekly_reflection.md`（日期取周末当天）
- 格式：

```markdown
# Weekly Reflection — 2026-04-13
...
- 🔴 [原始观察摘要] → `03 refined/axioms/aXX_xxx.md`
- 🔴 [原始观察摘要] → `03 refined/skills/xxx.md`
